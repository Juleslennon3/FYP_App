...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> fetchUserInfo() async {
    final String apiUrl =
        'https://3efd-80-233-12-225.ngrok-free.app/user/email/${widget.userEmail}';
    try {
  ...
  Future<void> fetchChild(int userId) async {
    final String apiUrl =
        'https://3efd-80-233-12-225.ngrok-free.app/view_child/$userId';
    try {
      final response = await http.get(Uri.parse(apiUrl));
  ...
  Future<void> authenticateFitbit() async {
    ...
    final String authApiUrl =
        'https://3efd-80-233-12-225.ngrok-free.app/authenticate_fitbit/${childData!['id']}';
  ...
  Future<void> refreshFitbitToken() async {
    if (childData == null) return;
    final String apiUrl =
        'https://3efd-80-233-12-225.ngrok-free.app/refresh_fitbit_token/${childData!['id']}';
    try {
  ...
  Future<void> reAuthenticateFitbit() async {
    ...
    final String reAuthApiUrl =
        'https://3efd-80-233-12-225.ngrok-free.app/re_authorize_fitbit/${childData!['id']}';
